  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // For now, disable signup in the UI since first admin should be created via backend
        toast.error("Please contact the administrator to create an account.");
      }
    } catch (error: any) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white text-gray-900 rounded-t-lg px-8 py-8 text-center border-b border-gray-200">
          <h1 className="text-3xl font-bold mb-2 text-blue-600">Canadian Nexus</h1>
